...
public class ValiFiCardType {
    public static final ValiFiCardType MASTERCARD
            = new ValiFiCardType("Mastercard",
            "^5[1-5][0-9]{5,}|222[1-9][0-9]{3,}|22[3-9][0-9]{4,}|2[3-6][0-9]{5,}|27[01][0-9]{4,}|2720[0-9]{3,}$");
    public static final ValiFiCardType AMERICAN_EXPRESS
            = new ValiFiCardType("American Express", "^3[47][0-9]{5,}$");
    public static final ValiFiCardType VISA
            = new ValiFiCardType("Visa", "^4[0-9]{6,}$");
    public static final ValiFiCardType DISCOVER
            = new ValiFiCardType("Discover", "^6(?:011|5[0-9]{2})[0-9]{3,}$");
    public static final ValiFiCardType DINERS_CLUB
            = new ValiFiCardType("Diners Club", "^3(?:0[0-5]|[68][0-9])[0-9]{4,}$");
    public static final ValiFiCardType JCB
            = new ValiFiCardType("JCB", "^(?:2131|1800|35[0-9]{3})[0-9]{3,}$");
