...
import com.applib.valifilib.ValiFiCardType;
import com.applib.valifilib.fields.number.ValiFieldLong;
...
public class ValiFieldCard extends ValiFieldLong {
    ...
    public ValiFieldCard(@Nullable Long defaultValue) {
        super(defaultValue);
        addSpecifiedValidator(getString(getErrorRes(ValiFi.Builder.ERROR_RES.ERROR_RES_CREDIT_CARD)));
    }

    public ValiFieldCard(int errorResource) {
        this(null, errorResource);
    }

    public ValiFieldCard(@Nullable Long defaultValue, int errorResource) {
        super(defaultValue);
     ...
     */
    protected static boolean isCreditCardKnown(String value, @NotNull Set<ValiFiCardType> knownTypes) {
